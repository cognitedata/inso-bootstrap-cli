...
def generate_deploy_config_01_is_valid_test_data():
    yield pytest.param(config := ROOT_DIRECTORY / "example/config-deploy-example-01.0.yml", ROOT_DIRECTORY / "example/.env_mock", id=config.name)
    yield pytest.param(config := ROOT_DIRECTORY / "example/config-deploy-example-01.1.yml", ROOT_DIRECTORY / "example/.env_mock", id=config.name)
    yield pytest.param(config := ROOT_DIRECTORY / "example/config-deploy-example-01.2.yml", ROOT_DIRECTORY / "example/.env_mock", id=config.name)
    yield pytest.param(config := ROOT_DIRECTORY / "example/config-deploy-example-01.3.yml", ROOT_DIRECTORY / "example/.env_mock", id=config.name)
